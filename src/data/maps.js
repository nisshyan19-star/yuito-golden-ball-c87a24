...
var MAPS = {
  ...
  town1: {
    ...
    npcs: [
      { x: 5, y: 7, sprite: 'girl_pink',
        pages: ['サッカー だいすき！\nおおきく なったら プロに なるんだ！', 'キミも しあいに でるの？\nがんばってね！'] },
      { x: 9, y: 10, sprite: 'grandpa',
        pages: ['わしは むかし キーパーを やっとった。', 'たまを こわがらん こころが\nいちばん たいせつじゃぞ。'] },
      { x: 12, y: 15, sprite: 'vendor',
        pages: ['いらっしゃい！\nピカピカの ボール、どうだい？', 'いい たまは いい プレーを\nうむのさ。'] },
  ...
  village1: {
    ...
    npcs: [
      { x: 16, y: 6, sprite: 'grandpa',
        pages: ['わしは この むらの ちょうろうじゃ。', 'せかいを すくうのは\nわかもの じゃな。たのむぞ。'] },
      { x: 8, y: 12, sprite: 'girl_pink',
        pages: ['この いどの みずは\nとっても つめたいの。', 'のどが かわいたら\nのんで いってね。'] },
      {
  ...
  town2: {
    ...
    npcs: [
      ...
      { x: 13, y: 9, sprite: 'boy_blue',
        pages: ['ぼく、あしが はやいんだ！\nおいかけっこ しよう！', 'サッカーは はしる スポーツ\nだもんね！'] },
      { x: 2, y: 15, sprite: 'supporter',
        pages: ['ぼくらは キミの おうえんだんだ！', 'フレー フレー、\nがんばれ ー！'] },
      {
        x: 3, y: 4, sprite: 'shopkeep', shop: {
          type: 'equip', name: 'そうび屋',
  ...
  town3: {
    ...
    npcs: [
      { x: 1, y: 8, sprite: 'reporter',
        pages: ['わたしは スポーツきしゃ。\nキミの かつやくを かいてるよ。', 'つぎの しあいも\nたのしみに してるね！'] },
      { x: 13, y: 10, sprite: 'granny',
        pages: ['そらの まちへ ようこそ。', 'くもの うえは きもちが\nいいじゃろう？'] },
      {
        x: 3, y: 4, sprite: 'shopkeep', shop: {
          type: 'item', name: 'どうぐ屋',
  ...
  // ══════════════════════════════════════════════════════════════════════
  //  隠し仲間3人の かくし部屋（各章の隠しワープ先・戦闘なし）
  //   入口ワープは親マップの warps に置き、ミニマップへ紫で常時表示される。
  //   到着(7,3)・加入NPC(7,6)・帰りワープ(7,10)。16列×12行・全床。
  // ══════════════════════════════════════════════════════════════════════
  cave1_secret: {
    id: 'cave1_secret',
    name: 'ほのおの おくのま',
